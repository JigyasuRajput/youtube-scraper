...
export const translations = {
  ja: {
    title: "釣具レビュー分析",
    subtitle: "YouTubeレビューからAIが感覚評価を抽出・スコアリング",
  ...
  en: {
    ...
    subtitle: "AI extracts and scores sensory evaluations from YouTube reviews",
    heroTitle: "Extract Sensory Ratings\nfrom YouTube Reviews",
    heroDescription:
    ...
    features: {
      ...
      analysisTitle: "AI Sensory Analysis",
      analysisDesc:
        "AI scores 6 sensory dimensions: grip feel, swing sensation, weight balance, and more.",
    ...
    steps: {
      ...
      step3: "AI Analyzes",
      step3Desc: "Sensory evaluations extracted from content",
      step4: "View Report",
    ...
    loading: {
      ...
      step3: "AI is analyzing sensory evaluations...",
      step3With: "AI is analyzing sensory evaluations... ({c}/{t})",
      label1: "Search",
      label2: "Extract",
      label3: "Analyze",
    },
